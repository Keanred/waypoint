    ...
    >
          ...
          >
            <Box sx={{ '& > *': { lineHeight: 1.2 } }}>
              ...
              >
                Productivity{' '}
                <Typography component="span" sx={{ color: colors.primary, fontSize: 'inherit', fontWeight: 'inherit', fontFamily: 'inherit' }}>
                  Analytics
                </Typography>
              </Typography>
            ...
            >
              ...
              >
                ...
                <Typography sx={{ fontFamily: 'Manrope', fontWeight: 700, color: colors.primary, letterSpacing: '-0.025em', fontSize: '0.875rem' }}>
                  7-Day Streak
                </Typography>
              </Box>
          ...
          >
            ...
            >
              ...
              />
              {/* Radial Score */}
              <Box sx={{ position: 'relative', width: 224, height: 224, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Box sx={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <Typography sx={{ fontSize: '3rem', fontWeight: 900, fontFamily: 'Manrope', letterSpacing: '-0.05em' }}>84</Typography>
                  <Typography sx={{ fontSize: '0.625rem', color: colors.onSurfaceVariant, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                    Score
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 3 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  >
                    <Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: colors.tertiary, animation: 'pulse 2s infinite' }} />
                    <Typography sx={{ fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                      Status: Peak Performance
                    </Typography>
                  </Box>
                  <Typography sx={{ fontSize: '1.5rem', fontWeight: 700, fontFamily: 'Manrope' }}>Intelligence Insight</Typography>
            ...
            >
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <Typography sx={{ color: colors.onSurfaceVariant, fontSize: '0.75rem', fontWeight: 700, fontFamily: 'Manrope' }}>
                  MOMENTUM
                </Typography>
              </Box>
              <Box sx={{ mt: 3 }}>
                ...
                >
                  7
                  <Typography component="span" sx={{ fontSize: '1.25rem', color: colors.onSurfaceVariant, letterSpacing: 'normal' }}>
                    days
                  </Typography>
                </Typography>
            ...
            >
              <Typography
                sx={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: colors.onSurfaceVariant, mb: 4 }}
              >
                Focus Distribution
              </Typography>
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
                ...
                <Box sx={{ position: 'relative', width: 160, height: 160 }}>
                  <Box sx={{ position: 'absolute', inset: 0, borderRadius: '50%', border: `12px solid ${colors.surfaceContainerHighest}` }} />
                  <Box
                    sx={{
                      position: 'absolute',
                      inset: 0,
                  ...
                  <Box sx={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                    ...
                    <Typography sx={{ fontSize: '9px', color: colors.onSurfaceVariant, fontWeight: 900, letterSpacing: '0.1em' }}>TOTAL</Typography>
                  </Box>
                </Box>
                {/* Legend */}
                <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                  {[
                    ...
                    <Box key={item.label} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', opacity: item.dimmed ? 0.5 : 1 }}>
            ...
            >
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
                <Typography
                  sx={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: colors.onSurfaceVariant }}
                >
                  Velocity Trends
                </Typography>
              ...
              {/* Bar Chart */}
              <Box sx={{ height: 192, width: '100%', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 0.5, position: 'relative' }}>
                {/* Grid Lines */}
                <Box
                  sx={{
                    position: 'absolute',
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
                ...
                <Typography sx={{ fontSize: '1.25rem', fontWeight: 700, fontFamily: 'Manrope' }}>AI Bottleneck Detector</Typography>
              </Box>
              <Box
                sx={{
                  display: 'grid',
